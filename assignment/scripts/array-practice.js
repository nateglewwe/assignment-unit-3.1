...
//Here's the creation of my favoriteFoods array:
let favoriteFoods = ['curry', 'carbonara', 'mochi']
...
//Creating my variable 'numberOfFoods':
...
let lastAnimalAlternate = animalArray[animalArray.length - 1];
console.log('Last animal (alt method) is', lastAnimalAlternate);
...
console.log('Added a fav dessert to favorite foods', favoriteFoods);
...
let entree = 'mozzerella sticks'
favoriteFoods.unshift(entree);
console.log('Added entree to beginning of fav foods', favoriteFoods);
...
console.log('Remvoed teal from colors array', colors);
console.log('Made teal the last color:', lastColor);
...
console.log('Rmoved the first color from array:', firstColor);
console.log('Now the colors list is:', colors);
